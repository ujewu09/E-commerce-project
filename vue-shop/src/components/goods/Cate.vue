        ...
        <el-dialog title="添加分类" :visible.sync="addCateDialogVisible" width="45%" @close="addCateDialogClosed">
            ...
            <el-form ref="addCateFormRef" :model="addCateForm" :rules="addCateFormRules" label-width="100px">
                ...
                <el-form-item label="父级分类：">
                    <!-- options用来指定数据源 -->
                    <!-- props用来指定配置对象 -->
                    <el-cascader expandTrigger="hover" :options="parentCateList" v-model="selectedKeys" :props="cascaderProps" @change="parentCateChange"
                     clearable checkStrictly></el-cascader>
                </el-form-item>
            </el-form>
            <!-- 底部区域 -->
